...
public class Interfacelocal  implements Parcelable {
    public static final Creator<Interfacelocal> CREATOR = new InterfaceProxyCreator();
    ...
    private Interfacelocal(final Parcel in) {
    ...
    public Interfacelocal(final Interface other) {
...
//        notifyPropertyChanged(BR.publicKey);
    ...
    private static class InterfaceProxyCreator implements Creator<Interfacelocal> {
        @Override
        public Interfacelocal createFromParcel(final Parcel in) {
            return new Interfacelocal(in);
        }

        @Override
        public Interfacelocal[] newArray(final int size) {
            return new Interfacelocal[size];
        }
    }
}
